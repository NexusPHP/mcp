...
final class GetTaskRequestParamsTest extends AbstractMcpTestCase
{
    ...
    {
        $original = new GetTaskRequestParams(taskId: 'task-1', meta: RequestMetaObjectFactory::create());

        self::assertSame($original->toArray(), GetTaskRequestParams::fromArray($original->toArray())->toArray());
    }
    ...
    public function testFromArrayRejectsInvalidInput(array $payload, string $expectedMessage): void
    {
        ...
        GetTaskRequestParams::fromArray($payload);
    }
