...
final class InputRequestKeyReusedExceptionTest extends AbstractMcpTestCase
{
    ...
    {
        $exception = new InputRequestKeyReusedException('task-1', 'confirm');

        self::assertSame('Task "task-1" already issued the input-request key "confirm".', $exception->getMessage());
    }
}
