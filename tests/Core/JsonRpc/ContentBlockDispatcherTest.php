...
final class ContentBlockDispatcherTest extends TestCase
{
    ...
    public function testFromArrayRejectsUnknownType(): void
    {
        ...
        $this->expectExceptionMessage('PromptMessage content wire "type" must be one of "text", "image", "audio", "resource_link", "resource"; "unknown" given.');
    ...
    {
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessage('CallToolResult content wire data missing "type".');
