 ...
 * @internal
 */
#[CoversClass(SubscribeRequestParams::class)]
#[CoversClass(ResourceRequestParams::class)]
#[CoversClass(RequestParams::class)]
#[Group('unit-tests')]
#[Group('core-tests')]
final class SubscribeRequestParamsTest extends TestCase
{
    public function testConstructionExposesUri(): void
    {
        $params = new SubscribeRequestParams('file:///x');
    ...
    {
        $params = new SubscribeRequestParams(
            'file:///x',
    ...
    {
        $params = SubscribeRequestParams::fromArray(['uri' => 'file:///x']);
    ...
    {
        $params = SubscribeRequestParams::fromArray([
            'uri' => 'file:///x',
            '_meta' => ['vendor' => 'x'],
        ]);
    ...
    {
        $original = new SubscribeRequestParams(
            'file:///x',
            new RequestMetaObject(null, ['vendor' => 'x']),
        );

        $rebuilt = SubscribeRequestParams::fromArray($original->toArray());
    ...
    public static function provideFromArrayRejectsInvalidWireDataCases(): iterable
    {
        yield 'missing uri' => [
            [],
            'SubscribeRequestParams wire data missing "uri".',
        ];

        yield 'uri not a string' => [
            ['uri' => 1],
            'SubscribeRequestParams wire "uri" must be a string, int given.',
        ];
