 ...
 * @internal
 */
#[CoversClass(GetTaskRequestParams::class)]
...
final class GetTaskRequestParamsTest extends TestCase
{
    ...
    {
        $params = new GetTaskRequestParams('task-abc');
    ...
    public function testFromArrayRejectsMissingTaskId(): void
    {
        ...
        $this->expectExceptionMessage('GetTaskRequestParams wire data missing "taskId".');

        GetTaskRequestParams::fromArray([]);
    }

    public function testFromArrayRejectsNonStringTaskId(): void
    {
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessage('GetTaskRequestParams wire "taskId" must be a string, int given.');

        GetTaskRequestParams::fromArray(['taskId' => 42]);
    }
}
