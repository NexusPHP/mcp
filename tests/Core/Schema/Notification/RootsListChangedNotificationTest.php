...
final class RootsListChangedNotificationTest extends TestCase
{
    ...
    {
        $notification = new RootsListChangedNotification(new EmptyNotificationParams(new MetaObject(['vendor' => 'x'])));
    ...
    {
        $notification = new RootsListChangedNotification(new EmptyNotificationParams(new MetaObject(['k' => 'v'])));
