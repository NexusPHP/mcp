...
#[Group('unit-tests')]
#[Group('core-tests')]
final class ToolListChangedNotificationTest extends TestCase
{
    ...
    {
        $notification = new ToolListChangedNotification(new EmptyNotificationParams(new Meta(['vendor' => 'x'])));
    ...
    {
        $notification = new ToolListChangedNotification(new EmptyNotificationParams(new Meta(['k' => 'v'])));
    ...
    public function testFromArrayRejectsNonObjectParams(): void
    {
        ...
        $this->expectExceptionMessage('ToolListChangedNotification wire "params" must be an object, string given.');
