...
final class ResourceListChangedNotificationTest extends TestCase
{
    ...
    {
        $notification = new ResourceListChangedNotification(new EmptyNotificationParams(new Meta(['vendor' => 'x'])));
    ...
    {
        $notification = new ResourceListChangedNotification(new EmptyNotificationParams(new Meta(['k' => 'v'])));
    ...
    public function testFromArrayRejectsNonObjectParams(): void
    {
        ...
        $this->expectExceptionMessage('ResourceListChangedNotification wire "params" must be an object, string given.');
