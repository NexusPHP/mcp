...
#[Group('unit-tests')]
#[Group('core-tests')]
final class PromptTest extends AbstractMcpTestCase
{
    ...
    {
        $prompt = new Prompt(name: 'code-review', title: 'Code Review', meta: new PayloadMetaObject(extras: ['k' => 'v']));
    ...
    {
        $prompt = new Prompt(name: 'Project Files');

        self::assertSame('Project Files', $prompt->name);
    }
