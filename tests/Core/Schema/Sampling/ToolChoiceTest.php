...
final class ToolChoiceTest extends TestCase
{
    ...
    public function testFromArrayRejectsNonStringMode(): void
    {
        ...
        $this->expectExceptionMessageIs('"toolChoice.mode" must be one of [\'auto\', \'none\', \'required\'], 7 given.');
    ...
    {
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessageIs('"toolChoice.mode" must be one of [\'auto\', \'none\', \'required\'], \'unknown\' given.');
