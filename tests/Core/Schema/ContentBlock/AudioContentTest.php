...
#[Group('unit-tests')]
#[Group('core-tests')]
final class AudioContentTest extends AbstractMcpTestCase
{
    ...
    {
        $content = new AudioContent(data: 'aGVsbG8=', mimeType: 'audio/mp3', meta: new PayloadMetaObject(extras: ['k' => 'v']));
