 ...
 * @internal
 */
#[CoversClass(PromptNotFoundException::class)]
#[CoversClass(AbstractJsonRpcProtocolException::class)]
#[Group('unit-tests')]
#[Group('server-tests')]
final class PromptNotFoundExceptionTest extends AbstractMcpTestCase
{
    public function testCarriesNameAndComposesMessage(): void
    {
        $e = new PromptNotFoundException('missing');

        self::assertSame('missing', $e->name);
        self::assertNull($e->requestId);
        self::assertSame('No prompt registered under name "missing".', $e->getMessage());
    }
