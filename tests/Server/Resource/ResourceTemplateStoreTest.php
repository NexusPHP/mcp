...
final class ResourceTemplateStoreTest extends AbstractMcpTestCase
{
    public function testListReturnsRegisteredTemplates(): void
    {
        $store = new ResourceTemplateStore([
            'file:///{name}.txt' => $this->buildEntry(new ResourceTemplate(name: 'alpha', uriTemplate: 'file:///{name}.txt')),
            'file:///{name}.log' => $this->buildEntry(new ResourceTemplate(name: 'beta', uriTemplate: 'file:///{name}.log')),
        ]);
    ...
    public function testConstructorRejectsIntegerEntryKey(): void
    {
        ...
        new ResourceTemplateStore([1 => $this->buildEntry(new ResourceTemplate(name: 'one', uriTemplate: 'file:///{x}.one'))]);
    }
    ...
    public function testConstructorRejectsEmptyStringEntryKey(): void
    {
        ...
        // @phpstan-ignore argument.type
        new ResourceTemplateStore(['' => $this->buildEntry(new ResourceTemplate(name: 'one', uriTemplate: 'file:///{x}.one'))]);
    }
    ...
    public function testConstructorRejectsEntryKeyThatDoesNotMatchTemplateUri(): void
    {
        ...
        new ResourceTemplateStore([
            'file:///{x}.one' => $this->buildEntry(new ResourceTemplate(name: 'one', uriTemplate: 'file:///{y}.one')),
        ]);
    }
    ...
    public function testConstructorRejectsTemplateWithLevel2Expression(): void
    {
        ...
        new ResourceTemplateStore([
            'file:///{+path}' => $this->buildEntry(new ResourceTemplate(name: 'paths', uriTemplate: 'file:///{+path}')),
        ]);
    }
    ...
    public function testConstructorRejectsTemplateWithAdjacentExpressions(): void
    {
        ...
        new ResourceTemplateStore([
            'file:///{a}{b}' => $this->buildEntry(new ResourceTemplate(name: 'ab', uriTemplate: 'file:///{a}{b}')),
        ]);
    }
    ...
    public function testReadDelegatesToFirstMatchingTemplateWithBindings(): void
    {
        ...
        $store = new ResourceTemplateStore([
            'weather://{city}/{day}' => $this->buildEntry(
    ...
    public function testRemoveResourceTemplateDropsItAndStopsMatchingIt(): void
    {
        ...
        $store = new ResourceTemplateStore(['file:///{path}' => $this->buildEntry($template)]);
        $changes = 0;
        $store->onListChanged(static function () use (&$changes): void { ++$changes; });
    ...
    {
        $store = new ResourceTemplateStore([
            'file:///{path}' => $this->buildEntry(new ResourceTemplate(name: 'files', uriTemplate: 'file:///{path}')),
        ]);
        $changes = 0;
        $store->onListChanged(static function () use (&$changes): void { ++$changes; });
    ...
    public function testConstructorRefusesAnUnconventionalName(): void
    {
        ...
        new ResourceTemplateStore(['mem://{p}' => $this->buildEntry(new ResourceTemplate(name: 'Project Files', uriTemplate: 'mem://{p}'))]);
    }
    ...
    public function testConstructorRefusesANonConservativeIconSrc(): void
    {
        ...
        new ResourceTemplateStore(['mem://{p}' => $this->buildEntry(new ResourceTemplate(name: 't', uriTemplate: 'mem://{p}', icons: [new Icon(src: 'ftp://example.com/icon.png')]))]);
    }
     ...
     */
    private function buildEntry(ResourceTemplate $template, ?\Closure $reader = null): ResourceTemplateEntry
    {
