 ...
 *
 * @extends JsonRpcRequest<'tests/test-client-request', array<string, mixed>>
 */
final readonly class TestClientRequest extends JsonRpcRequest implements ClientRequest
{
    ...
    {
        return 'tests/test-client-request';
    }
