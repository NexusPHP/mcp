 ...
 * @internal
 *
 * @extends JsonRpcNotification<'notifications/progress', array<string, mixed>>
 */
final readonly class ProgressLookalikeNotification extends JsonRpcNotification
{
    ...
    public static function fromArray(array $data): static
    {
        ...
        if (\array_key_exists('params', $data)) {
            Assert::that($data['params'])
                ->isArray('ProgressLookalikeNotification "params" must be an object, {type} given.')
                ->isMap('ProgressLookalikeNotification "params" must be a string-keyed object.')
            ;
