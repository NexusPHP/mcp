...
namespace Nexus\Mcp\Tests\Fixtures\Core\Extension;
 ...
 *
 * @implements ExtensionInterface<TContext>
 */
final readonly class StubExtension implements ExtensionInterface
{
    /**
