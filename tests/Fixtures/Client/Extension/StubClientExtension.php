 ...
 * @internal
 */
final readonly class StubClientExtension implements ClientExtensionInterface
{
    /**
     ...
     * @param list<non-empty-string>                                                                    $outboundRequests
     */
    public function __construct(
        ...
        private array $outboundRequests = [],
    ) {
    }
